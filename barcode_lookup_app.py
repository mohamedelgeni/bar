...
st.markdown(f"<h1 style='text-align: center; color:#3E3F3A; font-size:50px;'>{('مقاطعة المنتجات التي تدعم إسرائيل عن طريق تحديد البار كود الخاص ب المنتج وتحديد بديل', session_state.lang)}</h1>", unsafe_allow_html=True)
